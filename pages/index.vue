      ...
      >
        <div class="flex h-full items-center justify-center">
          <div class="px-6 text-center text-white md:px-12">
            ...
            >
              <NuxtLink to="/prendas/pantalones" class="" aria-current="page">
                Productos
              </NuxtLink>
            </button>
          </div>
...
<div class="bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <h2 class="mb-6 text-3xl font-bold text-center">
                <span class="text-danger dark:text-danger-500"
                  >Encuentra productos de las mejores </span
                >
                marcas a nivel mundial.
              </h2>
    <div class="mx-auto grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-4">     
      <img class="col-span-2 max-h-25 w-full object-contain lg:col-span-1 mt-10 mx-auto" src="/img/puma2.jpg" alt="Puma" width="158" height="48" />
      <img class="col-span-2 max-h-25 w-full object-contain lg:col-span-1 mt-20 mx-auto" src="/img/nike3.jpg" alt="Puma" width="158" height="48" />
      <img class="col-span-2 max-h-25 w-full object-contain lg:col-span-1 mx-auto" src="/img/nau2.png" alt="Nike" width="158" height="48" />
      <img class="col-span-2 max-h-25 w-full object-contain sm:col-start-2 lg:col-span-1 mt-12 mx-auto" src="/img/pull2.jpg" alt="Pull and Bear" width="158" height="48" />
  ...
  <!-- Contenedor de diseño para redireccionar a contacto -->
          ...
          <div class="w-full shrink-0 grow-0 basis-auto md:w-8/12">
            <div class="px-6 py-12 md:px-12">
              ...
              <p class="mb-6 pb-2 text-neutral-500 dark:text-neutral-300">
                Somos una tienda de ropa muy reconocida a nivel nacional e
                internacional por la calidad de nuetros artículos de prendas y
                accesorios.
              </p>
              <button
                type="button"
...
<div class="bg-white mt-32 mb-32">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-6 space-y-12 lg:grid lg:grid-cols-4 lg:gap-x-6 lg:space-y-0">
        <div v-for="(image, index) in images" :key="index" class="relative">
          <a :href="image.link" class="block relative group">
            <div class="w-full h-96 overflow-hidden rounded-lg mb-10">
              <img class="w-full h-full object-cover" :src="image.src" :alt="image.title">
            </div>
    ...
    <h2 class="mb-8 sm:mb-10 text-4xl sm:text-7xl font-bold">
        <span class="text-danger text-black dark:text-danger-500">Productos Destacados</span>
    </h2>
    <hr><br><br><br>
    
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-20 ">
        <div v-for="(product, index) in config.products" :key="product.ID" class="flex font-sans mb-12 sm:mb-0">
            <div class="flex-none w-full sm:w-48 relative">
    ...
    <div class="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        <div class="sm:max-w-lg">
          ...
          <p class="mt-4 text-xl text-gray-500">Este año es un nuevo verano donde tu manera de vestir influirá en tu estado.</p>
        </div>
        <div>
          <div class="mt-10">
    ...
    <div class="bg-gray-100 mt-64 mb-64 p-32">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-5">
        <div class="mx-auto max-w-2xl  py-16 sm:py-24 lg:max-w-none lg:py-10">
          ...
          <div
            class="mt-6 space-y-22 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0"
          >
            <div
...
html, body, #app {
  ...
  overflow-y: auto; /* Maneja el desbordamiento vertical con barras de desplazamiento */
}
...
export default {
  ...
  data() {
    return {
      images: [
        { src: '/img/ima3.jpg', title: 'Camisas', link: '/prendas/camisas' },
        { src: '/img/ima4.jpg', title: 'Pantalones', link: '/prendas/pantalones' },
        { src: '/img/ima5.jpg', title: 'Hoddies', link: '/prendas/hoodies' },
        { src: '/img/ima7.jpg', title: 'Shorts', link: '/prendas/shorts' },
