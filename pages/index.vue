      ...
      <div class="w-full shrink-0 grow-0 basis-auto md:w-8/12">
        <div class="px-6 py-12 md:px-12">
          <h2 class="mb-6 text-3xl font-bold">
            <span class="text-danger dark:text-danger-500">Tienda de ropa</span> 
            Basic Threads
          </h2>
          <p class="mb-6 pb-2 text-neutral-500 dark:text-neutral-300">
            Somos una tienda de ropa muy reconocida a nivel nacional e internacional por la
            calidad de nuetros artículos de prendas y accesorios.
          </p>
          <button
            type="button"
